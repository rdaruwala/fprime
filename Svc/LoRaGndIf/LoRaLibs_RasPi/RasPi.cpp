...
void SerialSimulator::println(const char* s)
{
  print(s);
  printf("\n");
}

void SerialSimulator::print(const char* s)
{
  printf(s);
}

void SerialSimulator::print(unsigned int n, int base)
{
  if (base == DEC)
    printf("%d", n);
  else if (base == HEX)
...
void SerialSimulator::print(char ch)
{
  printf("%c", ch);
}

void SerialSimulator::println(char ch)
{
  printf("%c\n", ch);
}

void SerialSimulator::print(unsigned char ch, int base)
{
  return print((unsigned int)ch, base);
}

void SerialSimulator::println(unsigned char ch, int base)
{
