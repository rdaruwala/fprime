...
public:
    ...
    HighCR5, ///< Bw = 20.8 kHz, Cr = 4/5, Sf = 64chips/symbol, CRC on
    HighCR8,    ///< Bw = 20.8 kHz, Cr = 4/8, Sf = 64chips/symbol, CRC on
    Turbo,     ///< Bw = 250 kHz, Cr = 4/6, Sf = 128chips/symbol, CRC on
    TurboX,  ///< Bw = 250 kHz, Cr = 4/5, Sf = 64chips/symbol, CRC on
    Slow,     ///< Bw = 20K8 kHz, Cr = 4/8, Sf = 2048chips/symbol, CRC on
    } ModemConfigChoice;
    ...
    virtual bool    send(const char* toSend);
    virtual bool    send(std::string toSend);
